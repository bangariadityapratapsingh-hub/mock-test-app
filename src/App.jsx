...
function App() {
  ...
  const matricPapers = [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: { en: "Review and prioritize key activities", hi: "प्रमुख गतिविधियों की समीक्षा करना और उन्हें प्राथमिकता देना" }
        },
        {
          question: {
        ...
        },
        {
          ...
          answer: { en: "Aunt", hi: "बुआ/मौसी/चाची" }
        },
        {
          question: {
        ...
        },
        {
          ...
          answer: { en: "Inform them and apologize", hi: "उन्हें सूचित करें और माफ़ी मांगें" }
        },
        {
          question: {
        ...
        },
        {
          ...
          answer: { en: "Hand it to the police", hi: "इसे पुलिस को सौंप दें" }
        },
        {
          question: {
          ...
          answer: { en: "Speaker", hi: "अध्यक्ष (स्पीकर)" }
        },
        {
          question: {
          ...
          answer: { en: "Aggregate supply", hi: "कुल आपूर्ति" }
        },
        {
          question: {
        ...
        },
        {
          ...
          answer: { en: "Shah Jahan", hi: "शाहजहाँ" }
        },
        {
          question: {
        ...
        },
        {
          ...
          answer: { en: "Rabindranath Tagore", hi: "रवींद्रनाथ टैगोर" }
        },
        {
          question: {
          ...
          answer: { en: "Natural Language Processing", hi: "नेचुरल लैंग्वेज प्रोसेसिंग" }
        },
        {
          question: {
        ...
        },
        {
          ...
          answer: { en: "Satyajit Ray", hi: "सत्यजीत रे" }
        },
        {
          question: {
          ...
          answer: { en: "Immigration", hi: "आप्रवासन" }
        },
        {
          question: {
          ...
          answer: { en: "Make in India", hi: "मेक इन इंडिया" }
        },
        {
          question: {
        ...
        },
        {
          ...
          answer: { en: "Grey schist", hi: "ग्रे शिस्ट" }
        },
        {
          question: {
          ...
          answer: { en: "Small entrepreneurs", hi: "छोटे उद्यमियों" }
        },
        {
          question: {
        ...
        },
        {
          ...
          answer: { en: "Ujjwala Yojana", hi: "उज्ज्वला योजना" }
        },
        {
          question: {
        ...
        },
        {
          ...
          answer: { en: "Multidimensional Poverty Index", hi: "बहुआयामी गरीबी सूचकांक" }
        },
        {
          question: {
          ...
          answer: { en: "Mumbai Port", hi: "मुंबई बंदरगाह" }
        },
        {
          question: {
          ...
          answer: { en: "Tamil Nadu", hi: "तमिलनाडु" }
        },
        {
          question: {
        ...
        },
        {
          ...
          answer: { en: "Andromeda", hi: "एंड्रोमेडा" }
        },
        {
          question: {
        ...
        },
        {
          ...
          answer: { en: "Ranji Trophy", hi: "रणजी ट्रॉफी" }
        },
        {
          question: {
        ...
        },
        {
          ...
          answer: { en: "-25 meters", hi: "-25 मीटर" }
        },
        {
          question: {
            en: "In a town, there are 3,800 females for every 4,000 males. What is the sex ratio (number of females per 1000 males)?",
            hi: "एक शहर में, प्रत्येक 4,000 पुरुषों पर 3,800 महिलाएँ हैं। लिंगानुपात (प्रति 1000 पुरुषों पर महिलाओं की संख्या) क्या है?"
          },
          options: {
            en: ["920", "940", "950", "960"],
            hi: ["920", "940", "950", "960"]
          },
          answer: { en: "950", hi: "950" }
        },
        {
          question: {
          ...
          answer: { en: "Right-angled", hi: "समकोण" }
        },
        {
          question: {
        ...
        {
          question: {
            en: "A shop offers two successive discounts: 15% and 10%. What is the single equivalent discount percentage?",
            hi: "एक दुकान दो क्रमिक छूट प्रदान करती है: 15% और 10%। एकल समतुल्य छूट प्रतिशत क्या है?"
          },
          options: {
            en: ["23.5%", "24.0%", "24.5%", "25.0%"],
            hi: ["23.5%", "24.0%", "24.5%", "25.0%"]
          },
          answer: { en: "23.5%", hi: "23.5%" }
        },
        {
          question: {
            en: "A merchant buys 50 mugs for ₹2,000. He sells 30 at ₹50 each and the remaining at ₹35 each. What is his profit or loss percentage?",
            hi: "एक व्यापारी ₹2,000 में 50 मग खरीदता है। वह 30 को ₹50 और शेष को ₹35 प्रत्येक की दर से बेचता है। उसका लाभ या हानि प्रतिशत क्या है?"
          },
          options: {
            en: ["8%", "10%", "12%", "15%"],
            hi: ["8%", "10%", "12%", "15%"]
        ...
        {
          question: {
            en: "A bus takes 8 hours to cover 400 km. If its speed is increased by 30 km/h, how much time will it take?",
            hi: "एक बस 400 km की दूरी तय करने में 8 घंटे लेती है। यदि चाल 30 km/h बढ़ा दी जाए, तो कितना समय लगेगा?"
          },
          options: {
            en: ["4 hours", "5 hours", "6 hours", "7 hours"],
            hi: ["4 घंटे", "5 घंटे", "6 घंटे", "7 घंटे"]
          },
          answer: { en: "5 hours", hi: "5 घंटे" }
        },
        {
          question: {
            en: "The average of 10 numbers is 45. If one number, 60, is replaced by 40, what is the new average?",
            hi: "10 संख्याओं का औसत 45 है। यदि एक संख्या 60 को 40 से प्रतिस्थापित किया जाए, तो नया औसत क्या है?"
          },
          options: {
            en: ["41", "42", "43", "44"],
            hi: ["41", "42", "43", "44"]
        ...
        {
          question: {
            en: "A recipe needs 4 cups of sugar to make 18 cookies. How many cups are needed to make 27 cookies?",
            hi: "एक रेसिपी में 18 कुकीज़ के लिए 4 कप चीनी चाहिए। 27 कुकीज़ के लिए कितने कप चाहिए?"
          },
          options: {
            en: ["5 cups", "6 cups", "7 cups", "8 cups"],
            hi: ["5 कप", "6 कप", "7 कप", "8 कप"]
          },
          answer: { en: "6 cups", hi: "6 कप" }
        },
        {
          question: {
          ...
          answer: { en: "12 5/11", hi: "12 5/11" }
        },
        {
          question: {
            en: "A bakery uses 24.6 kg of flour each day. Monday: 1/2 of daily. Tuesday: 20% more than Monday. Total flour used?",
            hi: "एक बेकरी प्रतिदिन 24.6 किग्रा आटा उपयोग करती है। सोमवार: 1/2, मंगलवार: सोमवार से 20% अधिक। दो दिनों में कुल आटा?"
          },
          options: {
          ...
          answer: { en: "27.06 kilograms", hi: "27.06 किलोग्राम" }
        },
        {
          question: {
          ...
          answer: { en: "Real numbers", hi: "वास्तविक संख्याएँ" }
        },
        {
          question: {
          ...
          answer: { en: "60 km/h", hi: "60 km/h" }
        },
        {
          question: {
            en: "A dealer gives 20% discount and still makes 12% profit. Cost price ₹1,500. What is the marked price?",
            hi: "एक डीलर 20% छूट देता है और 12% लाभ कमाता है। क्रय मूल्य ₹1,500 है। अंकित मूल्य क्या है?"
          },
          options: {
            en: ["₹1,900", "₹2,000", "₹2,100", "₹2,200"],
            hi: ["₹1,900", "₹2,000", "₹2,100", "₹2,200"]
          },
          answer: { en: "₹2,100", hi: "₹2,100" }
        },
        {
          question: {
        ...
        },
        {
          question: {
            ...
            hi: "एक ठोस बेलन को पिघलाया जाता है और उसी ऊँचाई लेकिन एक-तिहाई त्रिज्या वाले छोटे बेलनों में ढाला जाता है। कितने बन सकते हैं?"
          },
          options: {
            en: ["3", "6", "9", "12"],
            hi: ["3", "6", "9", "12"]
        ...
        {
          question: {
            en: "X and Y can complete a work in 10 days. Y alone can do it in 15 days. How many days will X alone take?",
            hi: "X और Y एक कार्य को 10 दिनों में पूरा कर सकते हैं। Y अकेला 15 दिनों में। X अकेला कितने दिनों में करेगा?"
          },
          options: {
            en: ["25 days", "30 days", "35 days", "40 days"],
            hi: ["25 दिन", "30 दिन", "35 दिन", "40 दिन"]
          },
          answer: { en: "30 days", hi: "30 दिन" }
        },
        {
          question: {
            en: "Fill in the blank: He was __ nervous to walk up on stage and perform.",
            hi: "Fill in the blank: He was __ nervous to walk up on stage and perform."
          },
          options: {
            en: ["somewhat", "fairly", "too", "quite"],
            hi: ["somewhat", "fairly", "too", "quite"]
          },
          answer: { en: "too", hi: "too" }
        },
        {
          question: {
        ...
        },
        {
          ...
          answer: { en: "Hospitable", hi: "Hospitable" }
        },
        {
          question: {
            en: "Find the error: They set up their camp (1) / besides the river (2) / and spent (3) / the entire night there (4).",
            hi: "Find the error: They set up their camp (1) / besides the river (2) / and spent (3) / the entire night there (4)."
          },
          options: {
          ...
          answer: { en: "besides the river (2)", hi: "besides the river (2)" }
        },
        {
          question: {
            en: "Find the error: The furniture (1) / in that old room are (2) / quite worn out (3) / and dusty (4).",
            hi: "Find the error: The furniture (1) / in that old room are (2) / quite worn out (3) / and dusty (4)."
          },
          options: {
          ...
          answer: { en: "in that old room are (2)", hi: "in that old room are (2)" }
        },
        {
          question: {
          ...
          answer: { en: "Garrulous", hi: "Garrulous" }
        },
        {
          question: {
          ...
          answer: { en: "Occurrence", hi: "Occurrence" }
        },
        {
          question: {
            en: "One-word substitution: \"A written law formally enacted by a legislative body.\"",
            hi: "एक-शब्द प्रतिस्थापन: \"A written law formally enacted by a legislative body.\""
          },
          options: {
            en: ["Ordinance", "Statute", "Manifesto", "Decree"],
            hi: ["Ordinance", "Statute", "Manifesto", "Decree"]
          },
          answer: { en: "Statute", hi: "Statute" }
        },
        {
          question: {
            en: "Arrange correctly: (1) He placed the vegetables in the pan. (2) He washed and chopped the vegetables. (3) He served the dish on a plate. (4) He lit the stove and added oil.",
            hi: "Arrange correctly: (1) He placed the vegetables in the pan. (2) He washed and chopped the vegetables. (3) He served the dish on a plate. (4) He lit the stove and added oil."
          },
          options: {
            en: ["2-1-4-3", "2-4-1-3", "4-2-1-3", "1-2-3-4"],
            hi: ["2-1-4-3", "2-4-1-3", "4-2-1-3", "1-2-3-4"]
          },
          answer: { en: "2-4-1-3", hi: "2-4-1-3" }
        },
        {
          question: {
            en: "One-word substitution: \"A person who studies the origin and historical development of words.\"",
            hi: "एक-शब्द प्रतिस्थापन: \"A person who studies the origin and historical development of words.\""
          },
          options: {
            en: ["Etymologist", "Anthropologist", "Philatelist", "Lexicographer"],
            hi: ["Etymologist", "Anthropologist", "Philatelist", "Lexicographer"]
          },
          answer: { en: "Etymologist", hi: "Etymologist" }
        },
        {
          question: {
            en: "Fill in the blank: This road is __ than the one we took on our last trip.",
            hi: "Fill in the blank: This road is __ than the one we took on our last trip."
          },
          options: {
            en: ["narrow", "narrower", "narrowest", "more narrow"],
            hi: ["narrow", "narrower", "narrowest", "more narrow"]
          },
          answer: { en: "narrower", hi: "narrower" }
        },
        {
          question: {
            en: "Fill in the blank: She delivered her speech __ clearly, earning applause from the audience.",
            hi: "Fill in the blank: She delivered her speech __ clearly, earning applause from the audience."
          },
          options: {
            en: ["much", "vary", "more", "quite"],
            hi: ["much", "vary", "more", "quite"]
          },
          answer: { en: "quite", hi: "quite" }
        },
        {
          question: {
          ...
          answer: { en: "Conscientious", hi: "Conscientious" }
        },
        {
          question: {
            en: "Arrange correctly: (1) She selected her size and added to cart. (2) She visited the website. (3) A confirmation appeared. (4) She entered payment details.",
            hi: "Arrange correctly: (1) She selected her size and added to cart. (2) She visited the website. (3) A confirmation appeared. (4) She entered payment details."
          },
          options: {
            en: ["2-1-4-3", "1-2-4-3", "2-4-1-3", "1-4-2-3"],
            hi: ["2-1-4-3", "1-2-4-3", "2-4-1-3", "1-4-2-3"]
          },
          answer: { en: "2-1-4-3", hi: "2-1-4-3" }
        },
        {
          question: {
            en: "Arrange correctly: (1) The machine dispensed cash. (2) She inserted her debit card. (3) She selected withdrawal and entered amount. (4) She entered her PIN.",
            hi: "Arrange correctly: (1) The machine dispensed cash. (2) She inserted her debit card. (3) She selected withdrawal and entered amount. (4) She entered her PIN."
          },
          options: {
            en: ["2-4-3-1", "4-2-1-3", "2-1-4-3", "1-2-4-3"],
            hi: ["2-4-3-1", "4-2-1-3", "2-1-4-3", "1-2-4-3"]
          },
          answer: { en: "2-4-3-1", hi: "2-4-3-1" }
        },
        {
          question: {
            en: "Arrange correctly: (1) She grabbed her bag and rushed out. (2) She prepared a quick breakfast. (3) She woke up to the alarm. (4) She reached the office just in time.",
            hi: "Arrange correctly: (1) She grabbed her bag and rushed out. (2) She prepared a quick breakfast. (3) She woke up to the alarm. (4) She reached the office just in time."
          },
          options: {
            en: ["3-1-2-4", "2-3-1-4", "1-2-3-4", "3-2-1-4"],
            hi: ["3-1-2-4", "2-3-1-4", "1-2-3-4", "3-2-1-4"]
          },
          answer: { en: "3-2-1-4", hi: "3-2-1-4" }
        },
        {
          question: {
            en: "Fill in the blank: No sooner had she opened the door __ the phone rang.",
            hi: "Fill in the blank: No sooner had she opened the door __ the phone rang."
          },
          options: {
            en: ["than", "when", "then", "as"],
            hi: ["than", "when", "then", "as"]
          },
          answer: { en: "than", hi: "than" }
        },
        {
          question: {
            en: "Arrange correctly: (1) The sapling grew into a tree. (2) She dug a small hole. (3) She watered it every day. (4) She placed the sapling into the hole.",
            hi: "Arrange correctly: (1) The sapling grew into a tree. (2) She dug a small hole. (3) She watered it every day. (4) She placed the sapling into the hole."
          },
          options: {
        ...
        {
          question: {
            en: "Meaning of idiom: \"Burn the midnight oil\"",
            hi: "मुहावरे का अर्थ: \"Burn the midnight oil\""
          },
          options: {
          ...
          answer: { en: "To work or study very late into the night", hi: "To work or study very late into the night" }
        },
        {
          question: {
            en: "Find the error: The principal shared (1) / a important announcement (2) / with all the (3) / students present (4).",
            hi: "Find the error: The principal shared (1) / a important announcement (2) / with all the (3) / students present (4)."
          },
          options: {
          ...
          answer: { en: "a important announcement (2)", hi: "a important announcement (2)" }
        },
        {
          question: {
            en: "Fill in the blank phrasal verb: The candle flickered, and she struggled to __ it __.",
            hi: "Fill in the blank phrasal verb: The candle flickered, and she struggled to __ it __."
          },
          options: {
            en: ["blow — out", "set — up", "put — off", "turn — over"],
            hi: ["blow — out", "set — up", "put — off", "turn — over"]
          },
          answer: { en: "blow — out", hi: "blow — out" }
        },
        {
          question: {
            en: "Find the error: He met (1) / a IAS officer (2) / at the seminar (3) / held last Friday (4).",
            hi: "Find the error: He met (1) / a IAS officer (2) / at the seminar (3) / held last Friday (4)."
          },
          options: {
          ...
          answer: { en: "a IAS officer (2)", hi: "a IAS officer (2)" }
        },
        {
          question: {
            en: "Meaning of idiom: \"Bite the bullet\"",
            hi: "मुहावरे का अर्थ: \"Bite the bullet\""
          },
          options: {
          ...
          answer: { en: "To endure a painful or difficult situation bravely", hi: "To endure a painful or difficult situation bravely" }
        },
        {
          question: {
            en: "Find the error: The manager was angry (1) / on the employee (2) / for reporting (3) / late to work (4).",
            hi: "Find the error: The manager was angry (1) / on the employee (2) / for reporting (3) / late to work (4)."
          },
          options: {
          ...
          answer: { en: "on the employee (2)", hi: "on the employee (2)" }
        }
      ]
    }
  ];
  ...
  const hscQuestions = [
    {
      question: { en: "Find next: 2, 4, 8, 16, ?", hi: "श्रृंखला पूरी करें: 2, 4, 8, 16, ?" },
      options: { en: ["18", "24", "32", "30"], hi: ["18", "24", "32", "30"] },
      answer: { en: "32", hi: "32" }
    }
  ];
  ...
  const graduateQuestions = [
    {
      question: { en: "Who wrote the Indian Constitution?", hi: "भारतीय संविधान किसने लिखा?" },
      options: { en: ["Nehru", "Ambedkar", "Gandhi", "Patel"], hi: ["नेहरू", "अंबेडकर", "गांधी", "पटेल"] },
      answer: { en: "Ambedkar", hi: "अंबेडकर" }
    }
  ];

  const hscPapers = [
    { title: "HSC Practice Paper", date: "2025", shift: "-", questions: hscQuestions }
  ];

  const graduatePapers = [
    { title: "Graduate Practice Paper", date: "2025", shift: "-", questions: graduateQuestions }
  ];
  ...
  const [screen, setScreen] = useState("home"); // home | test | result | review | history
  ...
  const papers =
    mode === "matric" ? matricPapers :
    mode === "hsc" ? hscPapers :
    mode === "graduate" ? graduatePapers : [];
  ...
  // Save history when result shows
  useEffect(() => {
    ...
    const newEntry = {
      ...
      timeUsed: Math.floor((60 * 60 - timeLeft) / 60) + "m " + ((60 * 60 - timeLeft) % 60) + "s"
    };
  ...
  const calculateResult = () => {
    ...
    questions.forEach((q, i) => {
      ...
      else if (answers[i] === q.answer[lang]) correct++;
      else wrong++;
    });
  ...
  if (!questions.length && mode && start) {
    return <div style={{ ...styles.app, display: "flex", alignItems: "center", justifyContent: "center" }}>
      <h2>No questions available for this paper.</h2>
    </div>;
  }
    ...
    return (
      <div style={styles.app}>
        <div style={styles.topBar}>
          <span style={{ fontWeight: "700", fontSize: "18px", color: "#60a5fa" }}>📊 Test History</span>
          <button style={styles.btn} onClick={() => setShowHistory(false)}>🔙 Back</button>
        </div>
        <div style={{ maxWidth: "800px", margin: "0 auto", padding: "20px" }}>
          {history.length === 0 ? (
            <div style={{ ...styles.card, textAlign: "center", padding: "40px" }}>
              <p style={{ color: "#94a3b8", fontSize: "16px" }}>No test history yet. Take a test to see your results here!</p>
              <button style={{ ...styles.btnPrimary, marginTop: "16px" }} onClick={() => setShowHistory(false)}>
                🏠 Go Back
              </button>
            </div>
          ) : (
            history.map((h, i) => {
              const pct = ((h.score / (h.total || 1)) * 100).toFixed(1);
              const color = pct >= 70 ? "#22c55e" : pct >= 40 ? "#f59e0b" : "#ef4444";
              return (
                <div key={i} style={{ ...styles.card, marginBottom: "16px" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "12px" }}>
                    <div>
                      <p style={{ fontWeight: "700", fontSize: "16px", color: "#60a5fa", margin: "0 0 4px" }}>📄 {h.paper}</p>
                      <p style={{ color: "#94a3b8", fontSize: "13px", margin: 0 }}>📅 {h.date}</p>
                    </div>
                    <div style={{ textAlign: "right" }}>
                      <p style={{ fontSize: "24px", fontWeight: "700", color, margin: "0 0 2px" }}>{h.score}</p>
                      <p style={{ color: "#94a3b8", fontSize: "12px", margin: 0 }}>out of {h.total}</p>
                    </div>
                  </div>
                  <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "8px", marginBottom: "12px" }}>
                    {[
                      { label: "✅ Correct", value: h.correct, color: "#22c55e" },
                      { label: "❌ Wrong", value: h.wrong, color: "#ef4444" },
                      { label: "⚪ Skipped", value: h.unattempted, color: "#94a3b8" },
                      { label: "🎯 Accuracy", value: h.accuracy + "%", color: "#60a5fa" }
                    ].map((stat, si) => (
                      <div key={si} style={{ background: "rgba(0,0,0,0.2)", borderRadius: "8px", padding: "8px", textAlign: "center" }}>
                        <p style={{ color: stat.color, fontWeight: "700", fontSize: "16px", margin: "0 0 2px" }}>{stat.value}</p>
                  ...
                  <div style={{ background: "rgba(0,0,0,0.3)", borderRadius: "6px", height: "8px", overflow: "hidden" }}>
                    <div style={{ width: `${Math.min(100, Math.max(0, pct))}%`, height: "100%", background: color, borderRadius: "6px", transition: "width 0.8s ease" }} />
                  </div>
                  <p style={{ color: "#64748b", fontSize: "12px", margin: "6px 0 0" }}>⏱ Time used: {h.timeUsed}</p>
                </div>
              );
            })
          )}
  ...
  if (!mode) {
    return (
      <div style={{ ...styles.app, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "100vh", padding: "20px" }}>
        <div style={{ textAlign: "center", marginBottom: "40px" }}>
          <div style={{ fontSize: "64px", marginBottom: "16px" }}>🎯</div>
          <h1 style={{ fontSize: "36px", fontWeight: "800", color: "#60a5fa", margin: "0 0 8px" }}>SSC Mock Test</h1>
          <p style={{ color: "#94a3b8", fontSize: "16px", margin: 0 }}>Staff Selection Commission — Exam Preparation Platform</p>
        </div>

        <div style={{ display: "flex", gap: "16px", flexWrap: "wrap", justifyContent: "center", marginBottom: "24px" }}>
          {[
            { key: "matric", label: "📘 Matriculation", desc: "Class 10 Level" },
            { key: "hsc", label: "📗 HSC (10+2)", desc: "Class 12 Level" },
            { key: "graduate", label: "🎓 Graduate", desc: "Degree Level" }
          ].map((m) => (
            <button key={m.key} onClick={() => setMode(m.key)} style={{
              ...
              <div style={{ fontSize: "28px", marginBottom: "8px" }}>{m.label.split(" ")[0]}</div>
              <div style={{ fontWeight: "700", fontSize: "16px", color: "#e2e8f0" }}>{m.label.slice(3)}</div>
              <div style={{ color: "#94a3b8", fontSize: "13px", marginTop: "4px" }}>{m.desc}</div>
            </button>
          ))}
        </div>

        <button onClick={() => setShowHistory(true)} style={{ ...styles.btn, borderColor: "rgba(96,165,250,0.4)", color: "#60a5fa" }}>
          📊 View Test History
        </button>

        <div style={{ marginTop: "32px", ...styles.card, maxWidth: "500px", width: "100%" }}>
          <h3 style={{ color: "#60a5fa", margin: "0 0 12px", fontSize: "15px" }}>📋 Exam Pattern</h3>
          <ul style={{ color: "#94a3b8", fontSize: "14px", paddingLeft: "18px", lineHeight: "2" }}>
            <li>60 Minutes duration</li>
            <li>+1 mark for each correct answer</li>
            <li>-0.25 negative marking for wrong answers</li>
  ...
  if (!start) {
    return (
      <div style={{ ...styles.app, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "100vh", padding: "20px" }}>
        <div style={{ ...styles.card, maxWidth: "520px", width: "100%", textAlign: "center" }}>
          <div style={{ fontSize: "48px", marginBottom: "12px" }}>📝</div>
          <h1 style={{ color: "#60a5fa", fontSize: "24px", margin: "0 0 8px" }}>SSC Mock Test</h1>
          <p style={{ color: "#94a3b8", marginBottom: "24px" }}>
            {currentPaper?.title} | {currentPaper?.date} | {currentPaper?.shift}
          </p>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px", marginBottom: "24px" }}>
            {[
              ...
              { label: "Max Marks", value: questions.length },
              { label: "Negative Marking", value: "0.25" }
            ].map((stat, i) => (
              <div key={i} style={{ background: "rgba(0,0,0,0.2)", borderRadius: "8px", padding: "12px" }}>
                <p style={{ color: "#94a3b8", fontSize: "12px", margin: "0 0 4px" }}>{stat.label}</p>
                <p style={{ color: "#60a5fa", fontSize: "20px", fontWeight: "700", margin: 0 }}>{stat.value}</p>
              </div>
            ))}
          </div>

          <div style={{ display: "flex", gap: "10px", justifyContent: "center", marginBottom: "16px" }}>
            <label style={{ color: "#94a3b8", fontSize: "14px" }}>Language:</label>
            <button style={{ ...styles.btn, padding: "6px 14px", ...(lang === "en" ? { background: "rgba(59,130,246,0.3)", borderColor: "#3b82f6" } : {}) }} onClick={() => setLang("en")}>English</button>
            <button style={{ ...styles.btn, padding: "6px 14px", ...(lang === "hi" ? { background: "rgba(59,130,246,0.3)", borderColor: "#3b82f6" } : {}) }} onClick={() => setLang("hi")}>हिंदी</button>
          </div>

          <div style={{ display: "flex", gap: "10px", justifyContent: "center" }}>
            <button style={styles.btnPrimary} onClick={() => setStart(true)}>🚀 Start Test</button>
            <button style={styles.btn} onClick={() => setMode(null)}>🔙 Back</button>
          </div>
        </div>
      </div>
    );
  ...
  if (showReview) {
    return (
      <div style={styles.app}>
        <div style={styles.topBar}>
          <span style={{ fontWeight: "700", fontSize: "18px", color: "#60a5fa" }}>📖 Answer Review</span>
          <div style={{ display: "flex", gap: "10px" }}>
            <button style={{ ...styles.btn, padding: "6px 14px" }} onClick={() => setLang(lang === "en" ? "hi" : "en")}>
              {lang === "en" ? "हिंदी" : "English"}
            </button>
            <button style={styles.btn} onClick={() => setShowReview(false)}>🔙 Back to Result</button>
          </div>
        </div>
        <div style={{ maxWidth: "800px", margin: "0 auto", padding: "20px" }}>
          {questions.map((q, i) => {
            const isCorrect = answers[i] === q.answer[lang];
            const attempted = !!answers[i];
            return (
              <div key={i} style={{
                ...styles.card,
                marginBottom: "16px",
                borderLeft: `4px solid ${!attempted ? "#64748b" : isCorrect ? "#22c55e" : "#ef4444"}`
              }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "8px" }}>
                  <span style={{ color: "#94a3b8", fontWeight: "600", fontSize: "14px" }}>Q{i + 1}</span>
                  <span style={{
                    padding: "3px 10px", borderRadius: "20px", fontSize: "12px", fontWeight: "600",
                    background: !attempted ? "rgba(100,116,139,0.2)" : isCorrect ? "rgba(34,197,94,0.2)" : "rgba(239,68,68,0.2)",
                    color: !attempted ? "#94a3b8" : isCorrect ? "#22c55e" : "#ef4444"
                  }}>
                    {!attempted ? "⚪ Skipped" : isCorrect ? "✅ Correct" : "❌ Wrong"}
                  </span>
                </div>
                <p style={{ fontSize: "15px", lineHeight: "1.6", marginBottom: "12px", color: "#e2e8f0" }}>{q.question[lang]}</p>
                <div style={{ display: "grid", gap: "6px" }}>
                  {q.options[lang].map((opt, oi) => {
                    const isAns = opt === q.answer[lang];
                    const isSel = opt === answers[i];
                    let bg = "rgba(255,255,255,0.04)";
                    let border = "1px solid rgba(255,255,255,0.08)";
                    let color = "#94a3b8";
                    if (isAns) { bg = "rgba(34,197,94,0.15)"; border = "1px solid rgba(34,197,94,0.5)"; color = "#22c55e"; }
                    if (isSel && !isAns) { bg = "rgba(239,68,68,0.15)"; border = "1px solid rgba(239,68,68,0.5)"; color = "#ef4444"; }
                    return (
                      <div key={oi} style={{ padding: "8px 14px", borderRadius: "8px", background: bg, border, color, fontSize: "14px", display: "flex", justifyContent: "space-between" }}>
                        <span>{["A", "B", "C", "D"][oi]}. {opt}</span>
                        {isAns && <span style={{ fontSize: "12px" }}>✓ Correct Answer</span>}
                        {isSel && !isAns && <span style={{ fontSize: "12px" }}>✗ Your Answer</span>}
                      </div>
                    );
                  })}
                </div>
          ...
          <div style={{ display: "flex", gap: "10px", flexWrap: "wrap", justifyContent: "center", paddingBottom: "40px" }}>
            <button style={styles.btn} onClick={() => setShowReview(false)}>🔙 Back to Result</button>
            <button style={styles.btnPrimary} onClick={handleRetakeTest}>🔄 Retake Test</button>
            <button style={styles.btn} onClick={handleGoHome}>🏠 Home</button>
          </div>
        </div>
      </div>
    );
  ...
  if (showResult) {
    ...
    const accuracy =
      result.correct + result.wrong === 0
        ? 0
        : ((result.correct / (result.correct + result.wrong)) * 100).toFixed(1);
    const attemptRate = ((result.correct + result.wrong) / total * 100).toFixed(1);
    const scorePercent = ((result.marks / total) * 100).toFixed(1);
    const grade = scorePercent >= 80 ? { label: "Excellent 🏆", color: "#f59e0b" }
      : scorePercent >= 60 ? { label: "Good 👍", color: "#22c55e" }
      : scorePercent >= 40 ? { label: "Average 📈", color: "#3b82f6" }
      : { label: "Keep Practicing 💪", color: "#ef4444" };

    return (
      <div style={styles.app}>
        <div style={styles.topBar}>
          <span style={{ fontWeight: "700", fontSize: "18px", color: "#60a5fa" }}>
        ...
        <div style={{ maxWidth: "700px", margin: "0 auto", padding: "24px 20px" }}>
          ...
          <div style={{ textAlign: "center", marginBottom: "28px" }}>
            ...
            <h2 style={{ fontSize: "28px", color: grade.color, margin: "0 0 6px" }}>{grade.label}</h2>
            <p style={{ color: "#94a3b8", fontSize: "15px" }}>
              {currentPaper?.title} — {currentPaper?.date}
            </p>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "12px", marginBottom: "24px" }}>
            {[
              ...
              { label: "Skipped", value: result.unattempted, color: "#94a3b8" },
              { label: "Score", value: result.marks, color: "#60a5fa" }
            ].map((s, i) => (
              <div key={i} style={{ ...styles.card, textAlign: "center", padding: "16px", borderTop: `3px solid ${s.color}` }}>
                <p style={{ color: s.color, fontSize: "26px", fontWeight: "800", margin: "0 0 4px" }}>{s.value}</p>
          ...
          <div style={{ ...styles.card, marginBottom: "20px" }}>
            <h3 style={{ color: "#60a5fa", margin: "0 0 16px", fontSize: "16px" }}>📊 Performance Analytics</h3>
            {[
              { label: "Score %", value: scorePercent, color: "#60a5fa" },
              { label: "Accuracy", value: accuracy, color: "#22c55e" },
              { label: "Attempt Rate", value: attemptRate, color: "#f59e0b" }
            ].map((stat, i) => (
              <div key={i} style={{ marginBottom: "14px" }}>
                ...
                <div style={{ background: "rgba(0,0,0,0.3)", borderRadius: "6px", height: "8px", overflow: "hidden" }}>
                  <div style={{ width: `${Math.min(100, Math.max(0, stat.value))}%`, height: "100%", background: stat.color, borderRadius: "6px", transition: "width 1s ease" }} />
                </div>
              </div>
            ))}
            <p style={{ color: "#64748b", fontSize: "13px", margin: "8px 0 0" }}>
              📉 Negative marks deducted: <span style={{ color: "#ef4444", fontWeight: "700" }}>-{(result.wrong * 0.25).toFixed(2)}</span>
            </p>
          </div>

          {/* Action Buttons */}
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "10px", marginBottom: "10px" }}>
            <button style={{ ...styles.btnPrimary, padding: "14px" }} onClick={() => setShowReview(true)}>
              📖 Review Answers
            </button>
            <button style={{ ...styles.btnSuccess, padding: "14px" }} onClick={handleRetakeTest}>
              🔄 Retake Test
            </button>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "10px" }}>
            <button style={{ ...styles.btn, padding: "12px", textAlign: "center" }} onClick={handleGoHome}>
              🏠 Go to Home
            </button>
            <button style={{ ...styles.btn, padding: "12px", textAlign: "center" }} onClick={() => setShowHistory(true)}>
              📊 View History
            </button>
          </div>
        </div>
  ...
  const flaggedCount = Object.values(review).filter(Boolean).length;
    ...
    <div style={styles.app}>
      ...
      <div style={styles.topBar}>
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          <span style={{ fontWeight: "700", color: "#60a5fa", fontSize: "16px" }}>SSC Mock Test</span>
          <span style={{ color: "#64748b", fontSize: "13px" }}>Q{current + 1}/{questions.length}</span>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          <span style={{
            padding: "6px 14px", borderRadius: "20px", fontWeight: "700", fontSize: "16px",
            background: timerWarning ? "rgba(239,68,68,0.2)" : "rgba(59,130,246,0.2)",
            color: timerWarning ? "#ef4444" : "#60a5fa",
            border: `1px solid ${timerWarning ? "rgba(239,68,68,0.5)" : "rgba(59,130,246,0.3)"}`
          }}>
            ⏱ {formatTime(timeLeft)}
          </span>
          <button
            style={{ ...styles.btn, padding: "6px 12px", fontSize: "12px" }}
            onClick={() => setLang(lang === "en" ? "hi" : "en")}
          >
            {lang === "en" ? "हिंदी" : "EN"}
          </button>
          <button
            style={{ ...styles.btnDanger, padding: "8px 14px", fontSize: "13px" }}
      ...
      {confirmSubmit && (
        <div style={{
          ...
          <div style={{ ...styles.card, maxWidth: "380px", width: "90%", textAlign: "center" }}>
            <div style={{ fontSize: "40px", marginBottom: "12px" }}>⚠️</div>
            <h3 style={{ color: "#e2e8f0", margin: "0 0 8px" }}>Submit Test?</h3>
            <p style={{ color: "#94a3b8", fontSize: "14px", marginBottom: "20px" }}>
              You have answered <strong style={{ color: "#60a5fa" }}>{answered}</strong> out of{" "}
              <strong>{questions.length}</strong> questions.
              {questions.length - answered > 0 && (
                <> <span style={{ color: "#f59e0b" }}>{questions.length - answered} unattempted.</span></>
              )}
            </p>
            <div style={{ display: "flex", gap: "10px", justifyContent: "center" }}>
              <button style={styles.btnSuccess} onClick={handleSubmitTest}>✅ Submit Now</button>
              <button style={styles.btn} onClick={() => setConfirmSubmit(false)}>Cancel</button>
            </div>
          </div>
        </div>
      )}

      <div className="container" style={{ display: "flex", maxWidth: "1100px", margin: "0 auto", padding: "20px", gap: "20px" }}>
        ...
        <div className="left" style={{ flex: 1 }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "14px", flexWrap: "wrap", gap: "8px" }}>
            <div>
              <div style={{ fontWeight: "700", color: "#e2e8f0" }}>{currentPaper?.title}</div>
              <div style={{ color: "#64748b", fontSize: "13px" }}>📅 {currentPaper?.date} &nbsp;🕒 {currentPaper?.shift}</div>
            </div>
            <select
              value={selectedPaperIndex}
              onChange={(e) => setSelectedPaperIndex(Number(e.target.value))}
              style={{ background: "rgba(255,255,255,0.1)", border: "1px solid rgba(255,255,255,0.2)", color: "#e2e8f0", padding: "6px 10px", borderRadius: "8px", fontSize: "13px" }}
            >
              {papers.map((paper, index) => (
                <option key={index} value={index} style={{ background: "#1e3a5f" }}>
          ...
          <div style={{ marginBottom: "16px" }}>
            ...
            <div style={{ background: "rgba(0,0,0,0.3)", borderRadius: "6px", height: "6px", overflow: "hidden" }}>
              <div style={{ width: `${progressPct}%`, height: "100%", background: "linear-gradient(90deg, #3b82f6, #06b6d4)", borderRadius: "6px", transition: "width 0.4s" }} />
            </div>
          </div>
          ...
          <div style={styles.card}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "12px" }}>
              <span style={{ background: "rgba(59,130,246,0.2)", color: "#60a5fa", padding: "4px 12px", borderRadius: "20px", fontSize: "13px", fontWeight: "600" }}>
                Question {current + 1}
              </span>
              <button
                onClick={() => setReview({ ...review, [current]: !review[current] })}
                style={{ background: review[current] ? "rgba(245,158,11,0.2)" : "rgba(255,255,255,0.05)", border: `1px solid ${review[current] ? "rgba(245,158,11,0.5)" : "rgba(255,255,255,0.1)"}`, color: review[current] ? "#f59e0b" : "#64748b", padding: "5px 12px", borderRadius: "8px", cursor: "pointer", fontSize: "13px", fontFamily: "'Segoe UI', sans-serif" }}
              >
                {review[current] ? "🚩 Flagged" : "⚑ Flag for Review"}
              </button>
            </div>
            <p style={{ fontSize: "16px", lineHeight: "1.7", color: "#e2e8f0", marginBottom: "20px" }}>
              {questions[current]?.question?.[lang]}
            </p>
            ...
            <div style={{ display: "grid", gap: "10px" }}>
              {questions[current]?.options?.[lang]?.map((opt, i) => {
                ...
                return (
                  <button
                    key={i}
                    onClick={() => { handleAnswer(opt); if (current < questions.length - 1) setCurrent(current + 1); }}
                    className={`button ${isSelected ? "selected" : ""}`}
                    style={{
                      display: "flex", alignItems: "center", gap: "12px",
                      padding: "12px 16px", borderRadius: "10px", cursor: "pointer",
                      textAlign: "left", width: "100%", fontFamily: "'Segoe UI', sans-serif",
          ...
          <div style={{ display: "flex", gap: "10px", alignItems: "center", marginTop: "16px", flexWrap: "wrap" }}>
            <button style={styles.btn} onClick={() => setCurrent(current - 1)} disabled={current === 0}>
              ⬅ Previous
            </button>
            {answers[current] && (
              <button
                style={{ ...styles.btn, color: "#ef4444", borderColor: "rgba(239,68,68,0.4)" }}
                onClick={clearAnswer}
              >
                🗑 Clear
              </button>
        ...
        <div className="right" style={{ width: "220px", flexShrink: 0 }}>
          <div style={styles.card}>
            <h3 style={{ margin: "0 0 12px", fontSize: "14px", color: "#94a3b8", fontWeight: "600" }}>Questions</h3>
            ...
            <div style={{ marginBottom: "12px", display: "flex", flexDirection: "column", gap: "5px" }}>
              {[
                ...
                { color: "#3b82f6", label: "Ans + Flagged" },
                { color: "#374151", label: "Unanswered" }
              ].map((l, i) => (
                <div key={i} style={{ display: "flex", alignItems: "center", gap: "6px", fontSize: "11px", color: "#64748b" }}>
                  <span style={{ width: "10px", height: "10px", background: l.color, borderRadius: "3px", display: "inline-block" }} />
                  {l.label}
                </div>
              ))}
            </div>
            ...
            {/* Stats */}
            <div style={{ marginBottom: "12px", padding: "8px", background: "rgba(0,0,0,0.2)", borderRadius: "8px", fontSize: "12px" }}>
              <div style={{ display: "flex", justifyContent: "space-between", color: "#94a3b8", marginBottom: "4px" }}>
                <span>Answered:</span><span style={{ color: "#22c55e", fontWeight: "700" }}>{answered}</span>
              </div>
              <div style={{ display: "flex", justifyContent: "space-between", color: "#94a3b8", marginBottom: "4px" }}>
                <span>Flagged:</span><span style={{ color: "#f59e0b", fontWeight: "700" }}>{flaggedCount}</span>
              </div>
              <div style={{ display: "flex", justifyContent: "space-between", color: "#94a3b8" }}>
                <span>Remaining:</span><span style={{ color: "#ef4444", fontWeight: "700" }}>{questions.length - answered}</span>
              </div>
            </div>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: "5px" }}>
              {questions.map((_, i) => {
                ...
                const isFlag = review[i];
                const isCur = i === current;
                let bg = "#1e293b";
                if (isAns && isFlag) bg = "#1d4ed8";
                else if (isAns) bg = "#15803d";
                else if (isFlag) bg = "#b45309";
                return (
                  <button
                    key={i}
                    ...
                    style={{
                      ...
                      border: isCur ? "2px solid #60a5fa" : "1px solid rgba(255,255,255,0.15)",
                      background: bg,
                      color: isAns || isFlag ? "white" : "#64748b",
                      fontFamily: "'Segoe UI', sans-serif",
                      outline: isCur ? "2px solid rgba(96,165,250,0.4)" : "none",
                      outlineOffset: "1px"
                    }}
                  >
                    {i + 1}
